...
class PPO:
    ...
    def __init__(
        ...
        clip_param_cf: float = 0.2,
        cf_loss_coef: float = 1.0,
        ...
        # CF parameters
        self.clip_param_cf = clip_param_cf
        self.cf_loss_coef = cf_loss_coef
    ...
    def update(self) -> dict[str, float]:
        ...
        for batch in generator:
            ...
            for _ in range(3):
                cf_advantages_batch = advantages_batch[torch.randperm(advantages_batch.size(0)), :]
            ...
            loss = (
                surrogate_loss
                + self.cf_loss_coef * surrogate_loss_cf
            ...
            mean_surrogate_loss_cf += surrogate_loss_cf.item()
        ...
        mean_surrogate_loss_cf /= num_updates
        ...
        loss_dict = {
            ...
            "surrogate_cf": mean_surrogate_loss_cf,
        }
        if self.rnd:
